...
public class Tetrahedron {
    ...
    public static final int[][] vertexFaces = new int[4][3];
    public static int[][] edgeVertices = new int[6][2];
    public static final int[][] vertexEdges = new int[4][3];
    ...
    private static void mapVertices() {
        for (int i = 0; i < faceSymmetries.length; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                int face3 = faceSymmetries[i][(j + 1) % 3];
    ...
    private static void mapEdges() {
        for (int face = 1; face <= 4; face++) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                int v1 = getVertexIndex(face, nextFace, adjacentFaces[(i + 1) % 3]);
                int v2 = getVertexIndex(face, nextFace, adjacentFaces[(i + 2) % 3]);
                addEdge(v1, v2);
            }
        }
    }
